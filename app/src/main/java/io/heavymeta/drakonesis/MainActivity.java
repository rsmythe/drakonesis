...
import io.heavymeta.drakonesis.DragonCommand.DragonHead;
import io.heavymeta.drakonesis.DragonCommand.DragonMouthState;
import io.heavymeta.drakonesis.DragonCommand.DragonWingState;
import io.heavymeta.drakonesis.DragonConnect.DragonConnect;
...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String ipString = prefs.getString(DrakonesisApplication.PREF_SERVER_ADDRESS,
                DrakonesisApplication.DEFAULT_IP);
        int port = prefs.getInt(DrakonesisApplication.PREF_SERVER_PORT,
                DrakonesisApplication.DEFAULT_PORT);
